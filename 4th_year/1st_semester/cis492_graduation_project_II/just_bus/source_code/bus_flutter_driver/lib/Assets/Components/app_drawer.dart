...
import 'package:bus_driver/Assets/Helpers/language.dart';
import 'package:bus_driver/Assets/Helpers/prefs.dart';
import 'package:bus_driver/Assets/Models/Providers/AppDrawer/drawer_background.dart';
import 'package:bus_driver/Assets/Models/server_status.dart';
import 'package:bus_driver/Assets/ThemesHandler/bloc/theme_bloc.dart';
import 'package:bus_driver/Assets/ThemesHandler/bloc/theme_event.dart';
...
class AppDrawer extends StatelessWidget {
        ...
        child: DropdownButton<String>(
          ...
          onChanged: (value) async {
            if (getLanguage() == 'en' && value != 'English' ||
              ...
              if (value == 'English') {
                Language.changeLanguage(context, 'en', true);
              } else {
                Language.changeLanguage(context, 'ar', true);
              }
              homeKey.currentState!.refreshRoutesList();
              homeKey.currentState!.showForegroundService();
            }
          },
        ),
      ),
  ...
  Widget _showActiveHours(BuildContext context) {
    return ListTile(
      leading: Icon(Icons.access_time, color: Theme.of(context).primaryColor),
      title: Text(translate('nav_drawer.working_hours')),
      onTap: () {
        Dialogs.getActiveHoursDialog(context);
      },
    );
  }
