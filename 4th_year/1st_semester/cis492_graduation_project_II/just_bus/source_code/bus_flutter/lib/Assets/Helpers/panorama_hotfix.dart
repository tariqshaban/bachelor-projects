...
class PanoramaHotfix extends StatefulWidget {
  const PanoramaHotfix({
    Key? key,
    this.latitude = 0,
    this.longitude = 0,
    this.zoom = 1.0,
...
class _PanoramaState extends State<PanoramaHotfix>
  ...
  Widget buildHotspotWidgets(List<Hotspot>? hotspots) {
    ...
    if (hotspots != null && scene != null) {
      for (Hotspot hotspot in hotspots) {
        ...
        final Offset origin = Offset(hotspot.width * hotspot.origin.dx,
            hotspot.height * hotspot.origin.dy);
  ...
  @override
  void didUpdateWidget(PanoramaHotfix oldWidget) {
