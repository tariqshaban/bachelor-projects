...
if(!$conn)
die($error);
$db=mysqli_select_db($conn,"student_bak");
if(!$db)
die($error);
...
if(mysqli_fetch_row(mysqli_query($conn,"select write_ac from uac where id='$_POST[id]'"))[0]==false && mysqli_num_rows(mysqli_query($conn,"select write_ac from uac where id='$_POST[id]'"))==1){
